            ...
            <div class="indices">
                ...
                <div class="index-item">
                    ...
                    <div class="index-data">
                        <span class="current-value">2,495.72</span> 
                        <span class="change positive">+7.08 (0.2%)</span>
                    </div>
                </div>
                <!-- 코스닥 -->
                <div class="index-item">
                    ...
                    <div class="index-data">
                        <span class="current-value">718.02</span> 
                        <span class="change positive">+0.06 (0.00%)</span>
                    </div>
                </div>
                <!-- 나스닥 -->
                <div class="index-item">
                    ...
                    <div class="index-data">
                        <span class="current-value">19,864.98</span> 
                        <span class="change positive">+243.3 (1.2%)</span>
                    </div>
                </div>
                <!-- S&P 500 -->
                <div class="index-item">
                    ...
                    <div class="index-data">
                        <span class="current-value">5,975.38</span> 
                        <span class="change positive">+32.91 (0.6%)</span>
                    </div>
                </div>
                <!-- VIX -->
                <div class="index-item">
                    ...
                    <div class="index-data">
                        <span class="current-value">16.04</span> 
                        <span class="change negative">-0.09 (-0.5%)</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <c:choose>
                        <c:when test="${not empty stockList}">
                            <c:forEach var="stock" items="${stockList}" varStatus="status">
                                <tr>
                                    <td>${status.index + 1}</td> <!-- 순위를 index로 계산 -->

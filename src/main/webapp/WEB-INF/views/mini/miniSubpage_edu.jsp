					...
					<div class="quiz-container">
						...
						<section class="search-section">
							<div class="search-bar-wrapper">
								<form onsubmit="openPopup(event)" class="search-bar">
									<input type="text" id="searchQuery" name="query"
										placeholder="교육 자료를 검색하세요" required>
									<button type="submit">검색</button>
								</form>
							</div>
							<div class="keyword" id="srchKeyword">
								<span class="tit"> "추천" 키워드</span> <a
									href="https://www.econedu.go.kr/user/playEcon/currEconTermDoc/menu/list"
									class="links">경제 사전</a> <a
									href="https://www.econedu.go.kr/user/findEcon/findEcon1/dtlGrp?p_player_type=FIND&p_conts_grp_id=CS0000004575&serchmenu=1"
									class="links">경제 읽기</a> <a
									href="https://www.econedu.go.kr/user/findEcon/findEcon1/dtlGrp?p_conts_grp_id=CS0000004577&serchmenu=1"
									class="links">쉬운 경제</a> <a
									href="https://www.econedu.go.kr/user/findEcon/findEcon1/dtlGrp?p_conts_grp_id=CS0000004627&serchmenu=1"
									class="links">정책 방향</a>
							</div>
						</section>
						...
						<section id="faq" class="faq-section">
							...
							<div class="faq-container">
								...
								<div class="faq-item">
									...
									<p>저희 사이트에서는 '금융 기초 배우기' 섹션에서 기본적인 금융 교육을 시작할 수 있습니다. 다양한
										학습 자료와 퀴즈를 통해 점진적으로 금융 지식을 쌓아가세요.</p>
								</div>
							</div>
						</section>
					</div>
...
function openPopup(event) {
   ...
   if (query) {
      var url = "https://www.econedu.go.kr/index?query=" + encodeURIComponent(query);

...
<body class="subpage">
	...
	<div class="subpageWrapper">
		...
		<div class="subpage-breadcrumbs">
			<a href="#">대출 상품</a> <span> > </span> <a href="#">소상공인 대출</a>
		</div>
	</div>
	...
	<div class="subpageWrapper">
        ...
        <section class="product-details">
            <div class="container">
                <div class="product-info">
                    <h2>상품 상세 정보</h2>
                    <ul>
                        <li><strong>가입대상:</strong> 소상공인 (사업자등록증 보유자)</li>
                <li><strong>대출금액:</strong> 100만원 ~ 1억원</li>
                <li><strong>대출기간:</strong> 12개월 ~ 60개월</li>
                <li><strong>상환방법:</strong> 원리금균등상환</li>
                <li><strong>기타 혜택:</strong> 매월 금리 적립, 우대금리 적용</li>
                    </ul>
                </div>
                </div>
                </section>
        ...
        <section class="notes">
            <div class="container">
                <h2>유의사항</h2>
                <ul>
                  <li>대출금액은 최대 1억원까지 가능합니다.</li>
                <li>사업자의 신용도에 따라 대출 한도와 금리가 달라질 수 있습니다.</li>
                <li>대출 연체 시 우대금리가 적용되지 않으며, 연체금리가 부과됩니다.</li>
                </ul>
            </div>
        </section>
        ...
        <section class="cta">
            <div class="container">
                <a href="/spike.com/products/newloan?productType=소상공인대출" class="button" id="joinButton">지금 가입하기</a>
            </div>
        </section>
    </main>

...
<body class="subpage">
	...
	<div class="subpageWrapper">
		...
		<div class="subpage-breadcrumbs">
			<a href="#">적금 상품</a> <span> > </span> <a href="#">청년 저축 적금</a>
		</div>
	</div>
	...
	<div class="subpageWrapper">
        ...
        <section class="hero">
            <div class="container">
                <h1>청년 저축 적금</h1>
                <p>청년들을 위한 특별한 혜택으로, 미래를 위한 첫걸음을 떼세요.</p>
            </div>
        </section>
        ...
        <section class="notes">
            <div class="container">
                <h2>유의사항</h2>
                <ul>
                <li>만 19세 이상 청년만 가입 가능합니다.</li>
                <li>중도해지 시, 약정 금리보다 낮은 금리가 적용됩니다.</li>
                <li>우대금리는 조건 충족 시에만 적용됩니다.</li>
                <li>정부 지원 혜택은 가입 후 일정 기간 동안 유지됩니다.</li>
            </ul>
            </div>
        </section>
        ...
        <section class="cta">
            <div class="container">
                <a href="../newsavings?selectedProduct=youth" class="button" id="joinButton">지금 가입하기</a>
            </div>
        </section>
    </main>

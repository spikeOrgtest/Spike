	...
	<main>
        ...
        <section class="products">
            <div class="container">
                ...
                <div class="product-grid" id="productGrid">
                    <a href="Subpage_C1.jsp" class="product-card">
                    ...
                    <a href="Subpage_C2.jsp" class="product-card">
                        <div class="card-header"></div>
                        <div class="card-body">
                            <h3>SPIKE 플래티넘 카드</h3>
                            <p>스페셜한 당신을 위한 카드!</p>
                    ...
                    <a href="Subpage_C3.jsp" class="product-card">
                        <div class="card-header"></div>
                        <div class="card-body">
                            <h3>SPIKE 디지털 카드</h3>
                            <p>최강 온라인 혜택!</p>
        ...
        <section class="products-2">
            <div class="container">
                <h2>카드 상품 목록</h2>
                <div class="product-grid" id="productGrid">
                    <a href="Subpage_C4.jsp" class="product-card">
                        <div class="card-header"></div>
                        <div class="card-body">
                            <h3>SPIKE 카드</h3>
                    ...
                    <a href="Subpage_C5.jsp" class="product-card">
                        <div class="card-header"></div>
                        <div class="card-body">
                            <h3>SPIKE AIR 카드</h3>
                    ...
                    <a href="Subpage_C6.jsp" class="product-card">
                        <div class="card-header"></div>
                        <div class="card-body">
                            <h3>플러스 카드</h3>

...
<body class="subpage">
	...
	<div class="subpageWrapper">
		...
		<div class="subpage-breadcrumbs">
			<a href="#">카드 상품</a> <span> > </span> <a href="#">SPIKE 플래티넘카드</a>
		</div>
	</div>
	...
	<div class="subpageWrapper">
        ...
        <section class="hero">
            <div class="container">
                <h1>SPIKE 플래티넘카드</h1>
                <p>고급스러운 혜택을 제공하는 프리미엄 카드! 쇼핑 및 해외 여행 혜택을 최대화!</p>
            </div>
        </section>
        ...
        <section class="product-details">
            <div class="container">
                <div class="product-info">
                    <h2>상품 상세 정보</h2>
                    <ul>
                        <li>가입대상: 개인 (만 30세 이상, 연소득 5천만원 이상)</li>
  <li>연회비: 100,000원</li>
  <li>카드종류: 신용카드</li>
  <li>주요 혜택: 고급 레스토랑, 쇼핑몰 할인</li>
  <li>기타 혜택: 프리미엄 서비스 및 해외 여행 혜택 제공</li>
                    </ul>
                </div>
                <div class="container">
            <img src="../../../images/product/PLATINUMCARD.png" width="50%" height="100%"/>
            </div>
                </div>
                </section>
...
<table>
  ...
  <tr>
    <td>고급 레스토랑 할인</td>
    <td>제휴 레스토랑에서 최대 20% 할인</td>
  </tr>
  <tr>
    <td>쇼핑몰 할인</td>
    <td>주요 쇼핑몰에서 최대 15% 할인</td>
  </tr>
  <tr>
    <td>해외 여행 혜택</td>
    <td>공항 라운지 무료 이용, 면세점 할인</td>
  </tr>
  <tr>
    <td>프리미엄 서비스</td>
    <td>VIP 전용 이벤트 및 서비스 제공</td>
  </tr>
</table>
                </div>
            </div>
  ...
  <li>카드 발급 완료 후 사용 시작</li>
        ...
        <section class="notes">
            <div class="container">
                <h2>유의사항</h2>
                <ul>
                    <li>연회비는 카드 발급 시 한 번 결제됩니다.</li>
  <li>해외 이용 시, 일부 국가에서 혜택이 제한될 수 있습니다.</li>
  <li>카드 사용 시 발생하는 연체금리 및 수수료가 부과됩니다.</li>
                </ul>
            </div>
        </section>

...
<body class="subpage">
	...
	<div class="subpageWrapper">
        ...
        <section class="hero">
            <div class="container">
                <h1>플러스 적금</h1>
            <p>플러스 적금으로 더 큰 목표를 이루세요. 목표 달성에 더 빠르고 확실하게 다가갈 수 있는 기회!</p>
            </div>
        </section>
        ...
        <section class="notes">
            <div class="container">
                <h2>유의사항</h2>
                <ul>
                    <li>플러스 금리 혜택은 목표 달성 시 적용됩니다.</li>
                <li>목표 달성 보너스는 특정 조건을 충족한 경우 지급됩니다.</li>
                <li>유연한 입출금이 가능하여 언제든지 자금을 관리할 수 있습니다.</li>
                </ul>
            </div>
        </section>
        ...
        <section class="cta">
            <div class="container">
                <a href="../newsavings?selectedProduct=plus" class="button" id="joinButton">지금 가입하기</a>
            </div>
        </section>
    </main>
